...
const routes = [
  ...
  },
  {
    ...
    name: "Dashboard",
    component: Dashboard,
    meta: { requiresAdmin: true, title: "Dashboard", template: "admin" },
  },
  {
    path: "/orders/:id",
    name: "Order",
    component: Order,
    meta: { requiresAdmin: true, title: "Order", template: "admin" },
  },
  {
    path: "/orders",
    name: "Orders",
    alias: "/orders/page/1",
    component: Orders,
    meta: { requiresAdmin: true, title: "Orders", template: "admin" },
  },
  {
